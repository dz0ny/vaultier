$(document).ready(function () {
    ...
    /******************** Sentry raven **/
    ApplicationLoader.queueFile(STATIC_URL + '/lib/raven-js/dist/raven.js');

    /******************** Jquery plugins **/
    ApplicationLoader.queueFile(STATIC_URL + '/lib/notify.js/notify.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/jstorage/jstorage.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/jquery-cookie/jquery.cookie.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/jquery.sessionstorage/jquery.sessionStorage.js');

    /******************** Generic **/

    ApplicationLoader.queueFile(STATIC_URL + '/scripts/local_componets/pohon/pohon.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/momentjs/moment.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/jsep/src/jsep.js');

    /******************** Cyphering core **/
    ApplicationLoader.queueFile(STATIC_URL + '/lib/cryptojs/components/core.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/cryptojs/components/enc-base64.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/cryptojs/components/md5.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/cryptojs/components/sha1.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/cryptojs/components/sha256.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/cryptojs/components/ripemd160.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/cryptojs/components/x64-core.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/cryptojs/components/sha512.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/cryptojs/rollups/aes.js');

    /******************** Signatures **/
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/jsrsasign/ext/jsbn.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/jsrsasign/ext/jsbn2.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/jsrsasign/ext/rsa.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/jsrsasign/ext/rsa2.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/jsrsasign/ext/base64.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/jsrsasign/rsapem-1.1.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/jsrsasign/rsasign-1.2.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/jsrsasign/asn1hex-1.1.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/jsrsasign/x509-1.1.js');
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/jsrsasign/crypto-1.1.js');

    /******************** RSA encoding **/
    ApplicationLoader.queueFile(STATIC_URL + '/lib/lib/jsencrypt/bin/jsencrypt.js');
    ...
    /******************** Ember extension **/
    ApplicationLoader.queueFile(STATIC_URL + '/scripts/local_componets/lib/ember-ext/Tree/EmberTree.js');
    ...
    ApplicationLoader.queueFile(STATIC_URL + '/lib/bootswatch/assets/css/bootwatch.min.css');
    ...
    ApplicationLoader.queueFile(STATIC_URL + '/lib/Keypress/keypress.js');
