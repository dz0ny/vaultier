...
function program3(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  stack2 = helpers.each.call(depth0, "role", "in", "block.roles", {hash:{},inverse:self.noop,fn:self.program(6, program6, data),contexts:[depth0,depth0,depth0],types:["ID","ID","ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\r\n        </table>\r\n\r\n\r\n    </div>\r\n\r\n    ");
  return buffer;
  }
...
function program8(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  options = {hash:{},inverse:self.noop,fn:self.program(8, program8, data),contexts:[depth0],types:["INTEGER"],hashContexts:hashContexts,hashTypes:hashTypes,data:data};
