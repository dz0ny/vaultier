...
function program1(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  stack2 = helpers['if'].call(depth0, "card.perms.create", {hash:{},inverse:self.noop,fn:self.program(8, program8, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\r\n\r\n                ");
  hashTypes = {};
  hashContexts = {};
...
function program25(depth0,data) {
  ...
  stack2 = ((stack1 = helpers.exp || depth0.exp),stack1 ? stack1.call(depth0, "( card.perms.invite || card.perms.create || card.perms.update || card.perms.delete)", options) : helperMissing.call(depth0, "exp", "( card.perms.invite || card.perms.create || card.perms.update || card.perms.delete)", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\r\n\r\n    <div class=\"pull-left\">\r\n        <h2>");
  hashTypes = {};
  hashContexts = {};
