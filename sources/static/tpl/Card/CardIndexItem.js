Ember.TEMPLATES["Card/CardIndexItem"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  options = {hash:{
    'class': ("panel panel-primary pull-left vlt-item vlt-card-item")
  },inverse:self.noop,fn:self.program(2, program2, data),contexts:[depth0,depth0],types:["STRING","ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data};
  stack2 = ((stack1 = helpers['link-to'] || depth0['link-to']),stack1 ? stack1.call(depth0, "Secret.index", "", options) : helperMissing.call(depth0, "link-to", "Secret.index", "", options));
