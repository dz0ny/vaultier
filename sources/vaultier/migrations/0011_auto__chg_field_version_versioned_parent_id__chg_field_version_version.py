...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Version.versioned_parent_id'
        db.alter_column(u'vaultier_version', 'versioned_parent_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Version.versioned_parent_type'
        db.alter_column(u'vaultier_version', 'versioned_parent_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contenttypes.ContentType']))

    def backwards(self, orm):

        # Changing field 'Version.versioned_parent_id'
        db.alter_column(u'vaultier_version', 'versioned_parent_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))

        # User chose to not deal with backwards NULL issues for 'Version.versioned_parent_type'
        raise RuntimeError("Cannot reverse this migration. 'Version.versioned_parent_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Version.versioned_parent_type'
        db.alter_column(u'vaultier_version', 'versioned_parent_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
