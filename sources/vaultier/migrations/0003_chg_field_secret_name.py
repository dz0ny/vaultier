...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Secret.name'
        db.alter_column(u'vaultier_secret', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Secret.name'
        db.alter_column(u'vaultier_secret', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
