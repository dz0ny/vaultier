...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vaultier_acl', (
            ...
            ('level', self.gf('vaultier.models.role_fields.RoleLevelField')()),
            ('direction', self.gf('vaultier.models.acl_fields.AclDirectionField')()),
        ...
        db.create_table(u'vaultier_member', (
            ...
            ('status', self.gf('vaultier.models.member_fields.MemberStatusField')(default=3)),
        ...
        db.create_table(u'vaultier_secret', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('vaultier.models.secret_fields.SecretTypeField')()),
