...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'vaultier_user', 'email', self.gf('modelext.lowercasefield.lowercasefield.LowerCaseCharField')(unique=True, max_length=255))

        # Changing field 'Member.invitation_email'
        db.alter_column(u'vaultier_member', 'invitation_email', self.gf('modelext.lowercasefield.lowercasefield.LowerCaseCharField')(max_length=1024, null=True))
