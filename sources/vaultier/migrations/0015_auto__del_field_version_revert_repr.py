...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Version.revert_repr'
        db.delete_column(u'vaultier_version', 'revert_repr')


    def backwards(self, orm):
        # Adding field 'Version.revert_repr'
        db.add_column(u'vaultier_version', 'revert_repr',
