...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vaultier_lost_key', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='distracted', on_delete=models.PROTECT, to=orm['vaultier.User'])),
        ...
        db.send_create_signal('vaultier', ['LostKey'])
