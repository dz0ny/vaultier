...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vaultier_version', (
            ...
            ('handler_cls', self.gf('vaultier.models.version.handler.VersionHandlerClassField')(max_length=255)),
            ('revert_data', self.gf('jsonfield.fields.JSONField')()),
            ('revert_fields', self.gf('jsonfield.fields.JSONField')()),
            ('revert_repr', self.gf('django.db.models.fields.TextField')()),
    ...
    models = {
        ...
        'vaultier.version': {
            ...
            'handler_cls': ('vaultier.models.version.handler.VersionHandlerClassField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
