...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vaultier_version', (
            ...
            ('handler_cls', self.gf('vaultier.models.version.fields.PythonClassField')(max_length=255)),
            ('object_data', self.gf('jsonfield.fields.JSONField')()),
            ('object_fields', self.gf('jsonfield.fields.JSONField')()),
            ...
            ('versioned_parent_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='version_versioned_parent', to=orm['contenttypes.ContentType'])),
            ('versioned_parent_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
    ...
    models = {
        ...
        'vaultier.member': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitation_email': ('vaultier.models.fields.LowerCaseCharField', [], {'max_length': '1024', 'null': 'True'}),
        ...
        'vaultier.user': {
            ...
            'email': ('vaultier.models.fields.LowerCaseCharField', [], {'unique': 'True', 'max_length': '255'}),
        ...
        'vaultier.version': {
            ...
            'handler_cls': ('vaultier.models.version.fields.PythonClassField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_data': ('jsonfield.fields.JSONField', [], {}),
            'object_fields': ('jsonfield.fields.JSONField', [], {}),
