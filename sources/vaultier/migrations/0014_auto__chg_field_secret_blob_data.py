...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Secret.blob_data'
        db.alter_column(u'vaultier_secret', 'blob_data', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Secret.blob_data'
        db.alter_column(u'vaultier_secret', 'blob_data', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
