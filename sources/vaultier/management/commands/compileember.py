...
from vaultier.management.utils import Console, NullConsole, ReadableError, cant_compile, cant_observe
...
class Command(BaseCommand):
    ...
    def handle(self, *command_args, **command_options):
        ...
        try:
            ...
            from vaultier.management.compiler import Compiler
            ...
            if command_options["watch"]:
                ...
                from vaultier.management.observer import Observer
