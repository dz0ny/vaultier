...
class Secret(ChangesMixin, SoftDeleteMixin, TreeIterableModelMixin, models.Model):
    ...
    data_checksum = models.CharField(null=True, blank=True, max_length=32)
    blob_data = models.FileField(upload_to=get_blob_data_filename, null=True, blank=True)
    blob_data_checksum = models.CharField(null=True, blank=True, max_length=32)
    blob_meta = models.TextField(null=True, blank=True)
    blob_meta_checksum = models.CharField(null=True, blank=True, max_length=32)
