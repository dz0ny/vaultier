class Manager(object):
    ...
    def get_user(self):
        if (self._user_required and ( not self._user or self._user.is_anonymous()) ):
            raise Exception('To store version valid user is required on version_context_manager');
        return self._user
