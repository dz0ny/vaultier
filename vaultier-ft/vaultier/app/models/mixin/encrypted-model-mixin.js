 ...
 */
export var EncryptedModelMixin = Ember.Mixin.create({
 ...
 */
export var decryptedField = function (encryptedField, decryptedField) {
    return Ember.computed(function (key, value) {
        if (!EncryptedModelMixin.detect(this)) {
            throw new Error('Only models with mixin EncryptedModelMixin can have decryptedField');
        }
