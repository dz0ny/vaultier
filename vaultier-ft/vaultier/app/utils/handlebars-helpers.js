...
/* global Po, marked, CryptoJS, moment, jsep */
//@todo: get rid of Po
//@todo: this monolithic file is nonsense - clear not used helpers, split to more files
...
export default Ember.Object.extend({
    ...
    printUser: function (user, options) {
        ...
        var dataContainer = (options.hash.container) ? 'data-container=".' + options.hash.container + '"' : '';
        ...
        if (disableTooltip) {
          ...
          tooltip = 'data-toggle="tooltip" {dataContainer} title="{prefix} {name} ({email})"'
