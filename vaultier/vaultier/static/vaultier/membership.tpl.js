...
function program14(depth0,data) {
  ...
  },hashTypes:{'controller': "ID",'roleLevels': "ID",'role': "ID",'block': "ID",'class': "STRING",'classNameBindings': "STRING"},hashContexts:{'controller': depth0,'roleLevels': depth0,'role': depth0,'block': depth0,'class': depth0,'classNameBindings': depth0},inverse:self.noop,fn:self.program(15, program15, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n\n                            ");
  return buffer;
  }
...
function program23(depth0,data) {
  ...
  },hashTypes:{'dataBinding': "STRING",'controllerBinding': "STRING",'contentBinding': "STRING",'optionValuePath': "STRING",'optionLabelPath': "STRING",'selectionBinding': "STRING",'placeholder': "STRING"},hashContexts:{'dataBinding': depth0,'controllerBinding': depth0,'contentBinding': depth0,'optionValuePath': depth0,'optionLabelPath': depth0,'selectionBinding': depth0,'placeholder': depth0},contexts:[depth0],types:["ID"],data:data})));
  data.buffer.push("\n                                                    </div>\n\n                                                </div>\n                                            ");
  return buffer;
  }
