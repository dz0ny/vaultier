...
function program1(depth0,data) {
  ...
  data.buffer.push("\n    <div class=\"alert alert-warning top-15\">\n        <b>Your access to this workspace is currently limited.<br/></b>\n        Workspace key has not been transfered to you yet. The key will be transfered to you automatically once\n        someone from the workspace team will go online.\n    </div>\n");
  }

function program3(depth0,data) {
  
  
  data.buffer.push("\n    <div class=\"alert alert-danger top-15\">\n        <b>Workspace key error<br/></b>\n        Your workspace key cannot be used to decode data. This means you have no access to this workspace secret data.\n        Ask someone from the workspace collaborators team to transfer workspace keys to you once more and try to access the workspace again.\n    </div>\n");
  }
...
function program3(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push(" </h2>\n                        </div>\n                        <div class=\"clearfix\"></div>\n                    </div>\n                </div>\n\n                <div class=\"top-50\">\n                    <div class=\"jumbotron vlt-bigbox vlt-no-keys\">\n                        <div class=\"vlt-header\">\n                            <div class=\"vlt-icon\">\n\n                            </div>\n                            <div class=\"vlt-title\">\n                                <h1>You do not have keys to this workspace yet</h1>\n                            </div>\n                        </div>\n                        <p>\n                            Please wait till workspace keys will be automatically transfered to you\n                            when somebody of the team goes online. You will get an email once keys are received.\n                            <br/>\n                            <br/>\n                            Keys are used to encrypt and decrypt workspace data and you cannot access it without them.\n                        </p>\n                    </div>\n\n                </div>\n\n            </div>\n        </div>\n\n        <div class=\"vlt-page-sidebar\">\n            <div class=\"vlt-sidebar-block\">\n                <div class=\"vlt-sidebar-block-heading\">\n                    <div class=\"vlt-header\">\n                        <img src=\"/static/vaultier/images/icon-workspace-grey.png\" class=\"vlt-icon\">\n\n                        <h3 class=\"vlt-title\">\n                            ");
  stack1 = helpers._triageMustache.call(depth0, "workspace.name", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n                        </h3>\n                    </div>\n                    <div class=\"vlt-body\">\n                        ");
